...
namespace FlightControlTests.Data.Repos
{
    ...
    {
        private static FlightDbContext _dbContext;
        private static BaseRepo<T> _repo;
        protected int entityCount;

        protected static DbContext Context => _dbContext;
        protected static BaseRepo<T> Repo => _repo;
